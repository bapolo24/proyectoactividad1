...
Perforacion = st.Page("perforacion.py", title="Perforacion", icon="📊")  # Define una página adicional para visualizar datos precargados.
Rerservorios = st.Page("reservorios.py", title="Reservorios", icon="📊")  # Define una página adicional para visualizar datos precargados.
